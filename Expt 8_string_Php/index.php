...
echo "Length of the concatenated string: " . $stringLength . "\n";

// 3. Finding a substring
$findSubstring = "World";
if (strpos($concatenatedString, $findSubstring) !== false) {
    echo "The substring '$findSubstring' is found in the string.\n";
} else {
    echo "The substring '$findSubstring' is not found in the string.\n";
}
